...
const stacks = [
    ...
    {   //GITHUB
        svg: `
        <svg width="221" height="215" viewBox="0 0 221 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('Visit my profile! Link in the contact section! https://github.com/seiler-emerson')">
