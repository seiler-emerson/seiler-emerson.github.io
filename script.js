...
const stacks = [
    { //Angular
        svg: `
        <svg width="206" height="215" viewBox="0 0 206 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('Aprendendo muito sobre componentização e SPAs!')")">
    ...
    {   //CSS3
        svg: `
        <svg width="192" height="215" viewBox="0 0 192 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('CSS, a base do estilo!')">
    ...
    {   //ECLIPSE
        svg: `
        <svg width="234" height="215" viewBox="0 0 234 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('Ide muito boa!')">
    ...
    {   //FIGMA
        svg: `
        <svg width="139" height="215" viewBox="0 0 139 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('Nada melhor que desenhar antes de codar!')">
    ...
    {   //GITHUB
        svg: `
        <svg width="221" height="215" viewBox="0 0 221 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('Que tal dar uma olhada no meu repositórtio?! Só acessar a área de contato!')">
    ...
    {   //HTML
        svg: `
        <svg width="192" height="215" viewBox="0 0 192 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('A estrutura da web!')">
    ...
    {   //JAVA
        svg: `
        <svg width="215" height="215" viewBox="0 0 215 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('Que o Java esteja com você! 🖖🏽')">
    ...
    {   //JS
        svg: 
        `<svg width="215" height="215" viewBox="0 0 215 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('O que seria de nós sem ele?')">
    ...
    {   //VSCODE
        svg: 
        `<svg width="216" height="215" viewBox="0 0 216 215" xmlns="http://www.w3.org/2000/svg" onclick="alert('Sensacional! Sem palavras!')">
